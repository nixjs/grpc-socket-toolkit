...
export namespace WSTypes {
    ...
    export type ExecuteSubscribeFunc<T = any> = (value: T) => void

    export type ExecuteBroadcastFunc = (state: WSEnums.ListenerTypes, type?: WSEnums.WebsocketEvents, ...args: any[]) => void
